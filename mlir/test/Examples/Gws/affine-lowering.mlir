// RUN: gwsc-ch5 %s -emit=mlir-affine 2>&1 | FileCheck %s
// RUN: gwsc-ch5 %s -emit=mlir-affine -opt 2>&1 | FileCheck %s --check-prefix=OPT

gws.func @main() {
  %0 = gws.constant dense<[[1.000000e+00, 2.000000e+00, 3.000000e+00], [4.000000e+00, 5.000000e+00, 6.000000e+00]]> : tensor<2x3xf64>
  %2 = gws.transpose(%0 : tensor<2x3xf64>) to tensor<3x2xf64>
  %3 = gws.mul %2, %2 : tensor<3x2xf64>
  gws.print %3 : tensor<3x2xf64>
  gws.return
}
...
// CHECK:         gws.print [[VAL_6]] : memref<3x2xf64>
...
// OPT:         gws.print [[VAL_6]] : memref<3x2xf64>

...
#include "gws/ShapeInferenceInterface.h"
...
#include "gws/ShapeInferenceOpInterfaces.cpp.inc"
...
struct ShapeInferencePass
    : public mlir::PassWrapper<ShapeInferencePass, OperationPass<gws::FuncOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ShapeInferencePass)
  StringRef getArgument() const override { return "gws-shape-inference"; }
...
std::unique_ptr<mlir::Pass> mlir::gws::createShapeInferencePass() {
